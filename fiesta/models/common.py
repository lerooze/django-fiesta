...
from ..constants import LANGUAGES, DATA_TYPES, TEXT_TYPES

class Text (models.Model):
    lang = models.CharField(max_length=max_length.LANG, default='en',
                            choices=LANGUAGES)
    text = models.CharField(max_length=max_length.NAME)
    text_type = models.CharField(max_length=max_length.DATA_TYPE, choices=TEXT_TYPES, null=True, blank=True)
...
class Annotation(models.Model):
    object_id = models.CharField('ID', max_length=max_length.OBJECT_ID, blank=True)
    annotation_title = models.CharField('title', max_length=max_length.ANNOTATION_TITLE, blank=True)
    annotation_type = models.CharField('type', max_length=max_length.ANNOTATION_TYPE, blank=True)
...
class Representation(models.Model):
    ...
    enumeration_format = models.ForeignKey(Format,
