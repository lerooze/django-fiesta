...
# ANNOTABLE_AFFAIRS = ['Organisation', 'Contact', 'OrganisationScheme',
...
#            'Dimension', 'Attribute', 'ProvisionAgreement',
#            'AttachmentConstraint', 'ContentConstraint', 'Group',
#            'DimensionLevelAttribute', 'Observation', 'ObservationAttribute']
...
CLASSTOPACKAGE = dict(
    AgencyScheme='base',
    DataProviderScheme='base',
    DataConsumerScheme='base',
    OrganisationUnitScheme='base'
) 
FLDTOSTRUCT = { 
    'agency_scheme': 'organisation_schemes',
    'data_consumer_scheme': 'organisation_schemes',
    'data_provider_scheme': 'organisation_schemes',
    'organisation_unit_scheme': 'organisation_schemes',
}

RESOURCES = ['organisationscheme', 'agencyscheme', 'dataproviderscheme',
             'dataconsumerscheme', 'organisationunitscheme', 'codelis',
             'conceptscheme']

QUERY_PARAMS = {
    'structure': {
        'detail': ['full', 'allstubs', 'referencestubs'],
        'references': ['none', 'parents', 'parentsandsiblings', 'children', 'descendants', 'all'] + RESOURCES 
    }
}
